...
namespace big
{
	void view::active_view()
	{
		...
		ImGui::SetNextWindowPos({(315.f + 20.f) * g.window.gui_scale, 100.f * g.window.gui_scale}, ImGuiCond_Always);
		ImGui::SetNextWindowSize({0.f, 0.f});
		ImGui::SetNextWindowSizeConstraints({310.f * g.window.gui_scale, 100.f},
